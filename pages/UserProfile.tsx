          ...
          {activeTab === 'about' && (
              <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6 sm:p-8 max-w-2xl">
                ...
                <p className="text-zinc-400 leading-relaxed mb-6 text-sm sm:text-base">
                  {isContentCreator 
                    ? "Passionate visual artist and verified creator on Elysian. Specializing in high-fidelity, creative content for an exclusive audience. Join my journey for a behind-the-scenes look at my world." 
                    : "Proud member of the Elysian community. Supporter of creative talent and high-quality digital media."}
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-black p-4 rounded-xl border border-zinc-800">
                    <p className="text-zinc-500 text-sm">Joined Platform</p>
                    <p className="text-white font-medium">October 2025</p>
                  </div>
                  <div className="bg-black p-4 rounded-xl border border-zinc-800">
                    <p className="text-zinc-500 text-sm">Main Location</p>
                    <p className="text-white font-medium">South Africa</p>
                  </div>
                </div>
              </div>
          )}
